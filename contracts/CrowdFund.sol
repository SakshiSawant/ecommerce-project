...
contract CrowdFund {
    ...
    function createCampaign(
        ...
        require(
            _fundingPeriodInDays >= 1 && _fundingPeriodInDays <= 7,
            "Funding Period should be between 1 to 7 days"
        );
    ...
    {
        return (
            campaigns[_index].campaignOwner,
    ...
    function fundCampaign(uint256 _campaignID, uint256 _price) public payable {
        ...
        require(
            campaigns[_campaignID].isExists,
            "This project does not exists"
        );
        require(
            campaigns[_campaignID].isCampaignOpen,
            "This project has been closed or ended"
        );
